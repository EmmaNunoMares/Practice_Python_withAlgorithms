"""
Given two non-empty arrays of integers, write a funtion that determines whether the second array is a subsequence of the first one
A subsequence of an array is a set of numbers that aren't necessaryly adjacent in the array bu that are in the same order as they apper in the array
Example [1,3,4] form a subsequence of the array [1,2,3,4]
